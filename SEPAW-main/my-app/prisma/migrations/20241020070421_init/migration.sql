...
CREATE TABLE takecareperson (
    ...
    takecare_id SERIAL PRIMARY KEY,
...
CREATE TABLE safezone (
    ...
    users_id INTEGER NOT NULL,
    safezone_id SERIAL PRIMARY KEY,
...
CREATE TABLE location (
    ...
    locat_noti_time TIMESTAMP NULL,
    locat_noti_status INTEGER
);

-- CreateTable
CREATE TABLE dlocation (
    dlocation_id SERIAL PRIMARY KEY,
    users_id INTEGER NOT NULL,
    ...
    locat_timestamp TIMESTAMP NOT NULL,
...
CREATE TABLE borrowequipment (
    ...
    borrow_delete_date TIMESTAMP,
    status INTEGER NOT NULL DEFAULT 1,
    borrow_approver INTEGER,
    borrow_approver_date TIMESTAMP,
    borrow_return_user_id INTEGER,
    borrow_return_date TIMESTAMP,
    borrow_send_date TIMESTAMP,
    borrow_send_return TIMESTAMP,
